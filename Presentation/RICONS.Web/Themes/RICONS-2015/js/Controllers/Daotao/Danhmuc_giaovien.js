...
function GetData(isHeader, mkh, stt) {
    ...
    var nguongiaovien = $('#filter02').val();
    var hovaten = $('#txthovatens').val();

    var DataJson = "{'nguongiaovien':'" + nguongiaovien + "'," +
                    "'hovaten':'" + hovaten + "'" +
                  "}";
    
    fncGetData(linkContent + 'Danhmuc/SelectRows_giaovien', DataJson, isHeader);
}
