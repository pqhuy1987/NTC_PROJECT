...
{
    public class KpiConstructionController : BaseController
    {
        #region Fields
        Log4Net _logger = new Log4Net(typeof(KpiConstructionController));
        ...
        public JsonResult SelectRows_KpiEmployee(KpiEmployeeModels model, int curentPage)
        {
            ...
            KpiConstructionServices service = new KpiConstructionServices();
        ...
        private StringBuilder PrepareDataJson_Employee(KpiEmployeeModels model, string couter)
        {
            ...
            try
            {
                ...
                sbResult.Append("\"col_value\":\"" + "<a href='" + Url.Action("Kpi_Construction_Edit", "KpiConstruction", new { makpinhanvien = model.makpinhanvien.ToString() }) + "'title=" + bmkpi + ">" + bmkpi + "</a>\"");
                sbResult.Append("},");
                ...
                sbResult.Append("\"col_value\":\"" + "<a href='" + Url.Action("Kpi_Construction_Edit", "KpiConstruction", new { makpinhanvien = model.makpinhanvien.ToString() }) + "'title='" + model.tenphongban + "'>" + model.tenphongban + "</a>\"");
                sbResult.Append("},");
                ...
                sbResult.Append("\"col_value\":\"" + "<a href='" + Url.Action("Kpi_Construction_Edit", "KpiConstruction", new { makpinhanvien = model.makpinhanvien.ToString() }) + "'title='" + model.manhanvien + "'>" + model.manhanvien + "</a>\"");
                sbResult.Append("},");
                ...
                sbResult.Append("\"col_value\":\"" + "<a href='" + Url.Action("Kpi_Construction_Edit", "KpiConstruction", new { makpinhanvien = model.makpinhanvien.ToString() }) + "'title='" + model.hovaten + "'>" + model.hovaten + "</a>\"");
                sbResult.Append("},");
                ...
                sbResult.Append("\"col_value\":\"" + "<a href='" + Url.Action("Kpi_Construction_Edit", "KpiConstruction", new { makpinhanvien = model.makpinhanvien.ToString() }) + "'title='" + model.tenchucdanh + "'>" + model.tenchucdanh + "</a>\"");
                sbResult.Append("},");
                ...
                sbResult.Append("\"col_value\":\"" + "<a href='" + Url.Action("Kpi_Construction_Edit", "KpiConstruction", new { makpinhanvien = model.makpinhanvien.ToString() }) + "'title='" + model.ngaydangky + "'>" + model.ngaydangky + "</a>\"");
                sbResult.Append("},");
        ...
        public ActionResult Kpi_Construction_New()
        {
            if (!IsLogged())
                return BackToLogin();
            DanhmucServices service = new DanhmucServices();
        ...
        public ActionResult Kpi_Construction_Edit(string makpinhanvien)
        {
            if (!IsLogged())
                return BackToLogin();
            List<KpiEmployeeModels> KpiEmployee = new List<KpiEmployeeModels>();
            KpiConstructionServices servicetp = new KpiConstructionServices();
        ...
        public JsonResult Save_KpiEmployee(string DataJson)
        {
            ...
            KpiConstructionServices services = new KpiConstructionServices();
        ...
        {
            JsonResult Data = new JsonResult();
            KpiConstructionServices servicevpp = new KpiConstructionServices();
