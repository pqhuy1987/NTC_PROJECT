    ...
    public class WeedMeetingBCTCController : BaseController
    {
        ...
        private StringBuilder PrepareDataJson_WeedMeeting(WeedMeetingModels model, string couter)
        {
            ...
            try
            {
                ...
                sbResult.Append("\"col_value\":\"" + "<a href='" + Url.Action("Edit", "WeedMeetingBCTC", new { macuochop = strEncryptCode }) + "'title='" + model.matuan + "'>" + model.tentuan + "</a>\"");
                sbResult.Append("},");
                ...
                sbResult.Append("\"col_value\":\"" + "<a href='" + Url.Action("Edit", "WeedMeetingBCTC", new { macuochop = strEncryptCode }) + "'title='" + model.ngayhop + "'>" + model.ngayhop + "</a>\"");
                ...
                sbResult.Append("\"col_value\":\"" + "<a href='" + Url.Action("Edit", "WeedMeetingBCTC", new { macuochop = strEncryptCode }) + "'title='" + model.loaicuochop + "'>" + model.tenloaicuochop + "</a>\"");
                sbResult.Append("},");
                ...
                sbResult.Append("\"col_value\":\"" + "<a href='" + Url.Action("Edit", "WeedMeetingBCTC", new { macuochop = strEncryptCode }) + "'title='" + model.maphongban + "'>" + model.tenphongban + "</a>\"");
                sbResult.Append("},");
                ...
                sbResult.Append("\"col_value\":\"<a href='" + Url.Action("DownloadFile", "WeedMeetingBCTC", new { tenfile = model.tenfile, idcode = model.uploadfile }) + "'>" + model.tenfile + "</a>\"");
                sbResult.Append("}");
