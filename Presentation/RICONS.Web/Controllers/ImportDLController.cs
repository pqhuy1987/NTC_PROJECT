...
{
    public class ImportDLController : Controller
    {
        //
        // GET: /ImportDL/
        ...
        public ActionResult Index(HttpPostedFileBase file)
        {
            ...
            if (Request.Files["file"].ContentLength > 0)
            {
                ...
                if (fileExtension == ".xls" || fileExtension == ".xlsx")
                {
                    ...
                    DataTable dt = new DataTable("dm_vanphongpham");
                ...
                NhapkhoServices nhapkho = new NhapkhoServices();
                nhapkho.Save_Importdl(ds.Tables[0]);
