...
$(document).ready(function (e) {
    ...
    //ngayKC.datepicker("setDate", new Date());
    //ngayKC.change(function () {
    //    if (!check_date(this))
    //        ngayKC.datepicker("setDate", new Date());
    //    if (check_over_date($(this).val(), ngayKT.val())) {
    //        ngayKC.datepicker("setDate", $(this).val());
    //    }
    //});

    var ngayHT = $('#txtngayhoanthanh');
    ngayHT.datepicker({
        dateFormat: "dd/mm/yy",
        defaultDate: new Date(),
        dayNamesShort: $.datepicker.regional.vi.dayNamesShort,
    ...
    //ngayHT.datepicker("setDate", new Date());
    //ngayHT.change(function () {
    //    if (!check_date(this))
    //        ngayHT.datepicker("setDate", new Date());
    //    if (check_over_date($(this).val(), ngayKT.val())) {
    //        ngayHT.datepicker("setDate", $(this).val());
    //    }
    //});
...
function GetData(isHeader, mpb, stt) {
    ...
    fncGetData_Hienthidulieu_theocongtruong(linkContent + 'PayStaff/SelectRows_ddns_addstaff_ddns_congtruong_kehoachbosungnhansu', DataJson, isHeader);
}
