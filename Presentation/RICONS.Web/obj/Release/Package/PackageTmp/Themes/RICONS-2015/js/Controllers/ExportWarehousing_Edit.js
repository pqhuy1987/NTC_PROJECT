...
function GetData(isHeader, idmadangky, stt) {
    ...
    fncGetData_Kiemkekho(linkContent + 'ExportWarehousing/SelectRows_Xuatkho_chitiet', DataJson, isHeader);
    //fncGetData_hieuchinhxuatkho(linkContent + 'ExportWarehousing/SelectRows_Xuatkho_chitiet', DataJson, isHeader);
