...
function GetData(isHeader, mpb, stt) {
    ...
    var nam = $('#filter02').val();
    var DataJson = "{'maphongban':'" + maphongban + "',"
                    + "'nam':'" + day.getFullYear() + "'"
                    +"}";
    fncGetData_loadkhong_header_Rom(linkContent + 'KpiEmployee/SelectRows_KpiLevelDepartmentDetail_hieuchinh', DataJson, isHeader);
