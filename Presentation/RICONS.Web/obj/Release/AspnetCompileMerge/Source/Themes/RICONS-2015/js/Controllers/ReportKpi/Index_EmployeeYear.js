...
function GetData(isHeader, stt ) {
    ...
    var maphongban = $("#filter01").val();
    var hovaten = $("#txtthongtintimkiem").val();
    //var STT = CheckNullOrEmpty(stt) == true ? "0" : stt;
    //var check = $("#chkkiemtra").val();
    var thangnam = $("#txtthangnam").val();
    var kiemtra = "";
    ...
    fncGetData_Timekeeping(linkContent + 'ReportKpi/SelectRows_KpiReport_Month', DataJson, isHeader);
}
