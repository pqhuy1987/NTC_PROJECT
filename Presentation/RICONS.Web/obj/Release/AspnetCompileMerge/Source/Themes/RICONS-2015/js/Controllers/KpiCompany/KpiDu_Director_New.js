...
function GetData(isHeader, mpb, stt) {
    ...
    var DataJson = "";
    fncGetData_loadkhong_header(linkContent + 'KpiCompany/SelectRows_LoadKPIfromCompanyDetail_photong_gdkhoi_gdduan_tp', DataJson, isHeader);
...
function GetData_loaddata(isHeader, mpb, stt) {
    ...
    var makpicanhancap = $('#txtmakpicanhancap').val();
    var DataJson = "{'makpicanhancap':'" + makpicanhancap + "'}";
    fncGetData_loadkhong_header(linkContent + 'KpiCompany/SelectRows_KpiLevelDuDirectorTpDetail_hieuchinh', DataJson, isHeader);
