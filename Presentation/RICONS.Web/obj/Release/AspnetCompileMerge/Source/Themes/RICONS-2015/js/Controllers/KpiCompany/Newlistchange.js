...
$(document).ready(function (e) {
    ...
    var ngayBD = $('#txtngaylapdanhsachdieudong');
    ngayBD.datepicker({
        dateFormat: "dd/mm/yy",
    ...
    GetData_lapdanhsachdieudong(false);
    GetData(false);

});

function GetData_lapdanhsachdieudong(isHeader, mpb, stt) {
    //debugger;
...
function GetData_lapdanhsachdieudong_timkiem(isHeader, mpb, stt) {
    ...
    fncGetData_loadkhong_header(linkContent + 'AddStaff/SelectRows_ddns_lapdanhsachdieudong_timkiem', DataJson, isHeader);
    //fncGetData_loadkhong_header_content1(linkContent + 'AddStaff/SelectRows_layds_congtruong_kehoachbosung', DataJson, isHeader);
}
