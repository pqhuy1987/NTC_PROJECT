...
function GetData(isHeader, mpb, stt) {
    ...
    var DataJson = "";
    fncGetData_loadkhong_header(linkContent + 'KpiCompany/SelectRows_KpiLevelConstruction_Item', DataJson, isHeader);

}

function GetData_loaddulaidulieu(isHeader, mpb, stt) {
    debugger;
