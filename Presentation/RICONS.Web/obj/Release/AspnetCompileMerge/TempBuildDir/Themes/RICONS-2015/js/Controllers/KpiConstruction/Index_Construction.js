...
$(document).ready(function (e) {
    ...
    $('#txttimkiemnam').on('keypress', function (event) {
...
function GetData(isHeader, stt ) {
    ...
    var tinhtrangduyet = $("#filter02").val();
    var namdangkykpi = $("#txttimkiemnam").val();
    ...
    var DataJson = "{'curentPage':'" + currentRow + "'," +
                    ...
                    "'tinhtrangduyet':'" + tinhtrangduyet + "'," +
                     "'namdangkykpi':'" + namdangkykpi + "'" +
                   "}";

    fncGetData_Timekeeping(linkContent + 'KpiCompany/SelectRows_KpiLevelConstruction', DataJson, isHeader);
}
