...
function GetData(isHeader, mpb, stt) {
    ...
    fncGetData_dangkyvpp_chitiet(linkContent + 'Warehousing/SelectRows_Nhapkho_chitiet', DataJson, isHeader);
    fncGetData_Kiemkekho(linkContent + 'Warehousing/SelectRows_DM_vanphongpham', DataJson, isHeader);


    //fncGetData_chitiet(linkContent + 'Warehousing/SelectRows_Phieunhapkho_chitiet', DataJson, isHeader);
