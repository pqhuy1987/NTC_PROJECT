...
{
    public class KpiEmployeeServices : BaseData
    {
        public KpiEmployeeServices()
        {
            logger = new Log4Net(typeof(KpiEmployeeServices));
        }

        #region KPI NHÂN VIÊN RICONS
        ...
        public List<KpiEmployeeModels> SelectRow_KpiEmployee_XuatExcel(string maphongban)
        {
            ...
            try
            {
                ...
                IList ilist = sqlMap.ExecuteQueryForList("KpiEmployee.SelectRow_KpiEmployee_XuatExcel", param);
                CastDataType cast = new CastDataType();
        ...
        public int CountRows_KpiEmployee(KpiEmployeeModels clparam)
        {
            ...
            try
            {
                ...
                iResult = (int)sqlMap.ExecuteQueryForObject("KpiEmployee.CountRows_KpiEmployee", param);
            }
            catch (Exception ex)
            {
        ...
        public List<KpiEmployeeModels> SelectRow_KpiEmployee(KpiEmployeeModels clParam, int trangbd, int trangkt)
        {
            ...
            try
            {
                ...
                IList ilist = sqlMap.ExecuteQueryForList("KpiEmployee.SelectRow_KpiEmployee", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiEmployeeModels>(ilist);
            }
            catch (Exception ex)
        ...
        public string Save_KpiEmployee(string DataJson, string nguoitao, string nguoilapgui, string truongphongduyet)
        {
            ...
            try
            {
                ...
                if (makpinhanvien.Trim() == "" || makpinhanvien.Trim() == "0" || makpinhanvien.Trim() == null)
                {
                    ...
                    sqlMap.Insert("KpiEmployee.InsertRow_KpiEmployee", param);
                }
                else
                {
                    param["makpinhanvien"] = makpinhanvien;
                    sqlMap.Update("KpiEmployee.UpdateRow_KpiEmployee", param);
                    //sqlMap.Delete("KpiEmployee.DeleteRow_KpiEmployeeDetail", param);
                }
                ...
                for (int i = 0; i < json_tiendo_giatri.Count(); i++)
                {
                    ...
                    if (makpinhanvien_chitiet.Trim() == "" || makpinhanvien_chitiet.Trim() == "0" || makpinhanvien_chitiet.Trim() == null)
                    {
                        ...
                        sqlMap.Insert("KpiEmployee.InsertRow_KpiEmployeeDetail", param1);
                    }
                    else
                    {
                        param1["makpinhanvien_chitiet"] = makpinhanvien_chitiet;
                        sqlMap.Update("KpiEmployee.UpdateRow_KpiEmployeeDetail", param1);
                    }
        ...
        public string Save_Ketquakpi(string DataJson, string nguoitao)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < json_tiendo_giatri.Count(); i++)
                {
                    ...
                    {
                        param1["makpinhanvien_chitiet"] = makpinhanvien_chitiet;
                        sqlMap.Update("KpiEmployee.UpdateRow_KpiEmployeeDetail_ketquakpi", param1);
                    }
                }
                sqlMap.CommitTransaction();
            }
        ...
        public string Save_KpiEmployee_nguoiguihoso(string makpinhanvien)
        {
            ...
            try
            {
                ...
                Hashtable param = new Hashtable();
                param["makpinhanvien"] = makpinhanvien;
                sqlMap.Update("KpiEmployee.UpdateRow_KpiEmployee_nguoihoso", param);
                sqlMap.CommitTransaction();
            }
            catch (Exception ex)
            {
        ...
        public List<KpiEmployeeModels> SelectRows_KpiEmployee_hieuchinh(string makpinhanvien)
        {
            ...
            try
            {
                Hashtable param = new Hashtable();
                param["makpinhanvien"] = makpinhanvien;
                IList ilist = sqlMap.ExecuteQueryForList("KpiEmployee.SelectRows_KpiEmployee_hieuchinh", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiEmployeeModels>(ilist);
            }
            catch (Exception ex)
        ...
        public List<KpiEmployeeDetailModels> SelectRows_KpiEmployeeDetail_hieuchinh(string makpinhanvien)
        {
            ...
            try
            {
                Hashtable param = new Hashtable();
                param["makpinhanvien"] = makpinhanvien;
                IList ilist = sqlMap.ExecuteQueryForList("KpiEmployee.SelectRows_KpiEmployeeDetail_hieuchinh", param);
                CastDataType cast = new CastDataType();
        ...
        public bool UpdateRow_Employee_duyet_khongduyet(string makpinhanvien, string dongy, string kpichinhsua,string kpict, string kpichinhsuact)
        {
            ...
            try
            {
                ...
                sqlMap.Update("KpiEmployee.UpdateRow_Employee_duyet_khongduyet", param);
                if(kpict.Length>0)
                {
                    ...
                    for (int i = 0; i < machuoi.Length; i++)
                    {
                        ...
                        sqlMap.Update("KpiEmployee.UpdateRow_Employee_detail_kpichinhsua", param);
                    }
                }
                else sqlMap.Update("KpiEmployee.UpdateRow_Employee_detail_kpichinhsua", param);
                sqlMap.CommitTransaction();
            }
            catch (Exception ex)
            {
        ...
        public bool UpdateRow_Employee_duyet_khongduyet_html(string makpinhanvien, string dongy)
        {
            ...
            try
            {
                ...
                param["truongphongxemxetkpi_duyet"] = dongy;
                param["truongphongxemxetkpi_ngay"] = DateTime.Now.ToString("dd/MM/yyyy");
                IList ilist = sqlMap.ExecuteQueryForList("KpiEmployee.SelectRows_KpiEmployeeDetail_html", param);
                if (ilist.Count > 0)
                {
                    for (int i = 0; i < ilist.Count; i++)
                    {
                        ...
                        sqlMap.Update("KpiEmployee.UpdateRow_Employee_detail_kpichinhsua", param1);
                    }
                }
                sqlMap.Update("KpiEmployee.UpdateRow_Employee_duyet_khongduyet", param);
        ...
        public bool Save_Yeucauchinhsua_chitiet(string madanhsach)
        {
            ...
            try
            {
                ...
                sqlMap.Update("KpiEmployee.UpdateEmployee_duyet_Yeucauchinhsua", param);
                for (int i = 0; i < json_tiendo_giatri.Count(); i++)
                {
                    ...
                    sqlMap.Update("KpiEmployee.Save_Yeucauchinhsua_chitiet", param);
                }
                sqlMap.CommitTransaction();
            }
            catch (Exception ex)
        ...
        public bool UpdateRow_Employee_duyet_Yeucauchinhsua(string makpinhanvien_chitiet, string dongy, string makpinhanvien)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < machuoi.Length; i++)
                {
                    ...
                    sqlMap.Update("KpiEmployee.UpdateEmployee_duyet_Yeucauchinhsua_chitiet", param);
                }
                sqlMap.CommitTransaction();
            }
            catch (Exception ex)
        ...
        public bool UpdateRow_Employee_Khoaketquakpi(string makpinhanvien)
        {
            ...
            try
            {
                ...
                sqlMap.Update("KpiEmployee.UpdateRow_Employee_Khoaketquakpi", param);
                sqlMap.Update("KpiEmployee.UpdateRow_Employee_Khoaketquakpi_chitiet", param);
                sqlMap.CommitTransaction();
            }
            catch (Exception ex)
            {
        ...
        public List<KpiLevelDepartmentDetailModels> SelectRows_KpiLevelDepartmentDetail_hieuchinh(string maphongban, string nam)
        {
            ...
            try
            {
                ...
                param["nam"] = nam;
                IList ilist = sqlMap.ExecuteQueryForList("KpiEmployee.SelectRows_KpiLevelDepartmentDetail_hieuchinh", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiLevelDepartmentDetailModels>(ilist);
            }
            catch (Exception ex)
        ...
        public bool DeletedRow_KpiEmployee(string makpinhanvien, string userid)
        {
            ...
            try
            {
                ...
                sqlMap.Update("KpiEmployee.DeletedRow_KpiEmployee", param);
                sqlMap.Update("KpiEmployee.DeletedRow_KpiEmployee_detail", param);
            }
            catch (Exception ex)
            {
                strResult = false;
        ...
        public bool Save_KpiEmployee_Xoadongdulieu(string makpinhanvien, string userid)
        {
            ...
            try
            {
                ...
                param["nguoitao"] = userid;
                sqlMap.Update("KpiEmployee.DeletedRow_KpiEmployee_detail_Deleted", param);
            }
            catch (Exception ex)
            {
                strResult = false;
