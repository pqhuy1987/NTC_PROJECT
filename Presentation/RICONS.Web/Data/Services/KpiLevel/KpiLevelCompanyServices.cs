...
{
    public class KpiLevelCompanyServices : BaseData
    {
        public KpiLevelCompanyServices()
        {
            logger = new Log4Net(typeof(KpiLevelCompanyServices));
        }

        #region KPI CẤP CÔNG TY
        public int CountRows_KpiLevelCompany(KpiLevelCompanyModels clparam)
        {
            logger.Start("CountRows_KpiLevelCompany");
            int iResult = 0;
            try
            {
                Hashtable param = new Hashtable();
                param = base.SetDataToHashtable(false, clparam);
                iResult = (int)sqlMap.ExecuteQueryForObject("KpiLevelCompany.CountRows_KpiLevelCompany", param);
            }
            catch (Exception ex)
            {
            ...
            logger.End("CountRows_KpiLevelCompany");
            return iResult;
        }

        public List<KpiLevelCompanyModels> SelectRow_KpiLevelCompany(KpiLevelCompanyModels clParam, int trangbd, int trangkt)
        {
            logger.Start("SelectRow_KpiLevelCompany");
            ...
            try
            {
                ...
                IList ilist = sqlMap.ExecuteQueryForList("KpiLevelCompany.SelectRow_KpiLevelCompany", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiLevelCompanyModels>(ilist);
            }
            catch (Exception ex)
            {
                logger.Error("Loi ---> " + ex.Message);
            }
            logger.End("SelectRow_KpiLevelCompany");
            return lstResult;
        }

        public string Save_KpiLevelCompany(string DataJson, string nguoitao,string nguoilapgui,string photongduyet,string tonggiamdocduyet)
        {
            logger.Start("Save_KpiLevelCompany");
            string makpicongty = "";
            try
            {
                ...
                makpicongty = json["data1"]["makpicongty"].ToString();
                param["bophansoanthao"] = json["data1"]["bophansoanthao"].ToString();
                param["ngaybanhanh"] = json["data1"]["ngaybanhanh"].ToString();
                param["ngaycapnhat"] = json["data1"]["ngaycapnhat"].ToString();

                param["nguoilapkpi"] = json["data1"]["nguoilapkpi"].ToString();
                param["nguoilapkpi_email"] = json["data1"]["nguoilapkpi_email"].ToString();
                param["nguoilapkpi_dagui"] = nguoilapgui;
                param["nguoilapkpi_ngay"] = json["data1"]["nguoilapkpi_ngay"].ToString();

                param["photongxemxetkpi"] = json["data1"]["photongxemxetkpi"].ToString();
                param["photongxemxetkpi_email"] = json["data1"]["photongxemxetkpi_email"].ToString();
                param["photongxemxetkpi_duyet"] = photongduyet;
                param["photongxemxetkpi_ngay"] = json["data1"]["photongxemxetkpi_ngay"].ToString(); 

                param["tonggiamdocxemxetkpi"] = json["data1"]["tonggiamdocxemxetkpi"].ToString();
                param["tonggiamdocxemxetkpi_email"] = json["data1"]["tonggiamdocxemxetkpi_email"].ToString();
                param["tonggiamdocxemxetkpi_duyet"] = tonggiamdocduyet;
                param["tonggiamdocxemxetkpi_ngay"] = json["data1"]["tonggiamdocxemxetkpi_ngay"].ToString();  //DateTime.Now.ToString("dd/MM/yyyy"); 

                param["nguoitao"] = nguoitao;
                param["nam"] = json["data1"]["nam"].ToString();
                if (makpicongty.Trim() == "" || makpicongty.Trim() == "0" || makpicongty.Trim() == null)
                {
                    param["lancapnhat"] = "01";
                    param["makpicongty"] = GetSequence_All("dm_seq", "KPI_Level_Company");
                    sqlMap.Insert("KpiLevelCompany.InsertRow_KpiLevelCompany", param);
                }
                else
                {
                    string catchuoi = json["data1"]["lancapnhat"].ToString().Split('/')[1];
                    param["lancapnhat"] = (int.Parse(catchuoi) + 1).ToString("00");
                    param["makpicongty"] = makpicongty;
                    sqlMap.Update("KpiLevelCompany.UpdateRow_KpiLevelCompany", param);
                    sqlMap.Delete("KpiLevelCompany.DeleteRow_KpiLevelCompanyDetail", param);
                }
                makpicongty = param["makpicongty"].ToString();
                ...
                for (int i = 0; i < json_tiendo_giatri.Count(); i++)
                {
                    ...
                    param1["makpicongty"] = param["makpicongty"].ToString().Trim();
                    ...
                    param1["tieuchidanhgia"] = System.Text.RegularExpressions.Regex.Replace(json_tiendo_giatri[i]["tieuchidanhgia"].ToString().Trim(), @"\n", "\\n").Replace("'", "");
                    param1["cachtinh"] = System.Text.RegularExpressions.Regex.Replace(json_tiendo_giatri[i]["cachtinh"].ToString().Trim(), @"\n", "\\n");
                    param1["ngayghinhanketqua"] = System.Text.RegularExpressions.Regex.Replace(json_tiendo_giatri[i]["ngayghinhanketqua"].ToString().Trim(), @"\n", "\\n");
                    param1["nguonchungminh"] = System.Text.RegularExpressions.Regex.Replace(json_tiendo_giatri[i]["nguonchungminh"].ToString().Trim(), @"\n", "\\n");
                    param1["nguonchungminh1"] = System.Text.RegularExpressions.Regex.Replace(json_tiendo_giatri[i]["nguonchungminh1"].ToString().Trim(), @"\n", "\\n");
                    ...
                    param1["ghichu"] = System.Text.RegularExpressions.Regex.Replace(json_tiendo_giatri[i]["ghichu"].ToString().Trim(), @"\n", "\\n").Replace("'", "");
                    param1["thuoccap"] = json_tiendo_giatri[i]["thuoccap"].ToString().Trim();
                    param1["nguoitao"] = nguoitao;
                    sqlMap.Insert("KpiLevelCompany.InsertRow_KpiLevelCompanyDetail", param1);
                }
            ...
            logger.End("Save_KpiLevelCompany");
            return makpicongty;
        }

        public List<KpiLevelCompanyModels> SelectRows_KpiLevelCompany_hieuchinh(string makpicongty)
        {
            logger.Start("SelectRows_KpiLevelCompany_hieuchinh");
            List<KpiLevelCompanyModels> lstResult = new List<KpiLevelCompanyModels>();
            try
            {
                Hashtable param = new Hashtable();
                param["makpicongty"] = makpicongty;
                IList ilist = sqlMap.ExecuteQueryForList("KpiLevelCompany.SelectRows_KpiLevelCompany_hieuchinh", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiLevelCompanyModels>(ilist);
            }
            catch (Exception ex)
            ...
            logger.End("SelectRows_KpiLevelCompany_hieuchinh");
            return lstResult;
        }

        public List<KpiLevelCompanyDetailModels> SelectRows_KpiLevelCompanyDetail_hieuchinh(string makpicongty)
        {
            logger.Start("SelectRows_KpiLevelCompanyDetail_hieuchinh");
            List<KpiLevelCompanyDetailModels> lstResult = new List<KpiLevelCompanyDetailModels>();
            try
            {
                Hashtable param = new Hashtable();
                param["makpicongty"] = makpicongty;
                IList ilist = sqlMap.ExecuteQueryForList("KpiLevelCompany.SelectRows_KpiLevelCompanyDetail_hieuchinh", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiLevelCompanyDetailModels>(ilist);
            }
            catch (Exception ex)
            {
                logger.Error("Loi ---> " + ex.Message);
            }
            logger.End("SelectRows_KpiLevelCompanyDetail_hieuchinh");
            return lstResult;
        }

        public string Save_KpiLevelCompany_nguoiguihoso(string makpicongty)
        {
            logger.Start("Save_KpiLevelCompany_nguoiguihoso");
            try
            {
                sqlMap.BeginTransaction();
                Hashtable param = new Hashtable();
                param["makpicongty"] = makpicongty;
                param["nguoilapkpi_dagui"] = "0";
                sqlMap.Update("KpiLevelCompany.UpdateRow_KpiLevelCompany_nguoiguihoso", param);
                sqlMap.CommitTransaction();
            }
            catch (Exception ex)
            {
            ...
            logger.End("Save_KpiLevelCompany_nguoiguihoso");
            return makpicongty;
        }

        public bool UpdateRow_KPICompany_Duyet_Khongduyet(string makpicongty, string dongy, string landuyet)
        {
            logger.Start("UpdateRow_KPICompany_Duyet_Khongduyet");
            bool strResult = true;
            try
            {
                sqlMap.BeginTransaction();
                ...
                if (landuyet.Trim()=="1")
                {
                    param["photongxemxetkpi_duyet"] = dongy;
                    param["photongxemxetkpi_ngay"] = DateTime.Now.ToString("dd/MM/yyyy");
                    param["tonggiamdocxemxetkpi_duyet"] = "";
                    param["tonggiamdocxemxetkpi_ngay"] = "";
                    if (dongy == "2" && landuyet == "1")
                        param["nguoilapkpi_dagui"] = "3"; // Phó tổng không duyệt
                    else param["nguoilapkpi_dagui"] = "1";
                }
                if (landuyet.Trim() == "2")
                {
                    param["photongxemxetkpi_duyet"] = "";
                    param["photongxemxetkpi_ngay"] = "";
                    param["tonggiamdocxemxetkpi_duyet"] = dongy;
                    param["tonggiamdocxemxetkpi_ngay"] = DateTime.Now.ToString("dd/MM/yyyy");
                    if (dongy == "2" && landuyet == "2")
                        param["nguoilapkpi_dagui"] = "4"; // Tổng giám đốc không duyệt
                    else param["nguoilapkpi_dagui"] = "1";
                }
                sqlMap.Update("KpiLevelCompany.UpdateRow_KPICompany_Duyet_Khongduyet", param);
                sqlMap.CommitTransaction();
            ...
            logger.End("UpdateRow_KPICompany_Duyet_Khongduyet");
            return strResult;
        }
        ...
        public int CountRows_KpiLevelDepartment(KpiLevelDepartmentModels clparam, string grouptk, string Sessionid)
        {
            logger.Start("CountRows_KpiLevelDepartment");
            int iResult = 0;
            try
            {
                Hashtable param = new Hashtable();
                param = base.SetDataToHashtable(false, clparam);
                if (grouptk == "1") // Thay toan bo giu lieu và của tất cà phòng bna
                {
                    param["userid"] = "";
                    if (clparam.maphongban != "0")
                        param["maphongban"] = clparam.maphongban;
                    else param["maphongban"] = "";
                }
                    
                else if (grouptk == "2") // Xem du lieu phong va du lieu cap nhan vien cua minh
                {
                    param["userid"] = "";
                    param["maphongban"] = clparam.maphongban;
                }
                else if (grouptk == "" || grouptk == "0") //Chỉ thấy dử liệu phong ban va ca nhan
                {
                    param["userid"] = Sessionid;
                    param["maphongban"] = clparam.maphongban;
                }
                if (clparam.timkiemnam == "" || clparam.timkiemnam == "undefined" || clparam.timkiemnam == null)
                    param["timkiemnam"] = "";
                else param["timkiemnam"] = clparam.timkiemnam;

                if (clparam.tinhtrangduyet == "0")
                    param["tinhtrangduyet"] = "";
                else param["tinhtrangduyet"] = clparam.tinhtrangduyet;
                iResult = (int)sqlMap.ExecuteQueryForObject("KpiLevelDepartment.CountRows_KpiLevelDepartment", param);
            }
            catch (Exception ex)
            {
                sqlMap.RollbackTransaction();
            ...
            logger.End("CountRows_KpiLevelDepartment");
            return iResult;
        }

        public List<KpiLevelDepartmentModels> SelectRow_KpiLevelDepartment(KpiLevelDepartmentModels clParam, int trangbd, int trangkt, string grouptk, string Sessionid)
        {
            logger.Start("SelectRow_KpiLevelDepartment");
            ...
            try
            {
                ...
                param["trangbd"] = trangbd;
                param["trangkt"] = trangkt;
                IList ilist = sqlMap.ExecuteQueryForList("KpiLevelDepartment.SelectRow_KpiLevelDepartment", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiLevelDepartmentModels>(ilist);
            }
            catch (Exception ex)
            {
                logger.Error("Loi ---> " + ex.Message);
            }
            logger.End("SelectRow_KpiLevelDepartment");
            return lstResult;
        }


        public List<KpiLevelCompanyDetailModels> SelectRows_LoadKPIfromCompanyDetail_theophongban(string maphongban)
        {
            logger.Start("SelectRows_LoadKPIfromCompanyDetail_theophongban");
            List<KpiLevelCompanyDetailModels> lstResult = new List<KpiLevelCompanyDetailModels>();
            try
            {
                Hashtable param = new Hashtable();
                param["maphongban"] = maphongban;
                IList ilist = sqlMap.ExecuteQueryForList("KpiLevelDepartment.SelectRows_LoadKPIfromCompanyDetail_theophongban", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiLevelCompanyDetailModels>(ilist);
            }
            catch (Exception ex)
            ...
            logger.End("SelectRows_LoadKPIfromCompanyDetail_theophongban");
            return lstResult;
        }

        public string Save_KpiLevelDepartment(string DataJson, string nguoitao, string nguoilapgui, string photongduyet, string tonggiamdocduyet)
        {
            logger.Start("Save_KpiLevelDepartment");
            string makpiphongban = "";
            try
            {
                sqlMap.BeginTransaction();
                Hashtable param = new Hashtable();
                ...
                makpiphongban = json["data1"]["makpiphongban"].ToString();
                ...
                param["photongxemxetkpi"] = json["data1"]["photongxemxetkpi"].ToString();
                param["photongxemxetkpi_duyet"] = photongduyet;
                param["photongxemxetkpi_ngay"] = json["data1"]["photongxemxetkpi_ngay"].ToString(); //DateTime.Now.ToString("dd/MM/yyyy");
                ...
                if (makpiphongban.Trim() == "" || makpiphongban.Trim() == "0" || makpiphongban.Trim() == null)
                {
                    param["makpiphongban"] = GetSequence_All("dm_seq", "KPI_Level_Department");
                    param["bankiemsoat_email"] = string.Format(Functiontring.ReturnStringFormatthongtincauhinhmail("smtp_user_bkskpi"));
                    sqlMap.Insert("KpiLevelDepartment.InsertRow_KpiLevelDepartment", param);
                }
                else
                {
                    param["makpiphongban"] = makpiphongban;
                    sqlMap.Update("KpiLevelDepartment.UpdateRow_KpiLevelDepartment", param);
                    //sqlMap.Delete("KpiLevelDepartment.DeleteRow_KpiLevelDepartmentDetail", param);
                }
                makpiphongban = param["makpiphongban"].ToString();
                Hashtable param1 = new Hashtable();
                JArray json_tiendo_giatri = (JArray)json["data2"];
                for (int i = 0; i < json_tiendo_giatri.Count(); i++)
                {
                    param1 = new Hashtable();
                    param1["makpiphongban"] = param["makpiphongban"].ToString().Trim();
                    param1["stt"] = json_tiendo_giatri[i]["stt"].ToString().Trim();
                    param1["makpiphongban_chitiet"] = json_tiendo_giatri[i]["makpiphongban_chitiet"].ToString().Trim();
                    param1["congty"] = json_tiendo_giatri[i]["congty"].ToString().Trim();
                    param1["sttcon"] = json_tiendo_giatri[i]["sttcon"].ToString().Trim();
                    param1["sttcha"] = json_tiendo_giatri[i]["sttcha"].ToString().Trim();
                    ...
                    if (param1["makpiphongban_chitiet"].ToString().Trim() == "" || param1["makpiphongban_chitiet"].ToString().Trim() == "0" || param1["makpiphongban_chitiet"].ToString().Trim() == null)
                    {
                        sqlMap.Insert("KpiLevelDepartment.InsertRow_KpiLevelDepartmentDetail", param1);
                    }
                    else
                        sqlMap.Update("KpiLevelDepartment.UpdateRow_KpiLevelDepartmentDetail", param1);
            ...
            logger.End("Save_KpiLevelDepartment");
            return makpiphongban;
        }

        public List<KpiLevelDepartmentModels> SelectRows_KpiLevelDepartment_hieuchinh(string makpicongty)
        {
            logger.Start("SelectRows_KpiLevelDepartment_hieuchinh");
            List<KpiLevelDepartmentModels> lstResult = new List<KpiLevelDepartmentModels>();
            try
            {
                Hashtable param = new Hashtable();
                param["makpiphongban"] = makpicongty;
                IList ilist = sqlMap.ExecuteQueryForList("KpiLevelDepartment.SelectRows_KpiLevelDepartment_hieuchinh", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiLevelDepartmentModels>(ilist);
            }
            catch (Exception ex)
            ...
            logger.End("SelectRows_KpiLevelDepartment_hieuchinh");
            return lstResult;
        }

        public List<KpiLevelDepartmentDetailModels> SelectRows_KpiLevelDepartmentDetail_hieuchinh(string makpicongty)
        {
        ...
        public string Save_KpiLevelDepartment_nguoiguihoso(string makpiphongban)
        {
            logger.Start("Save_KpiLevelDepartment_nguoiguihoso");
            try
            {
                sqlMap.BeginTransaction();
                Hashtable param = new Hashtable();
                param["makpiphongban"] = makpiphongban;
                param["nguoilapkpi_dagui"] = "0";
                sqlMap.Update("KpiLevelDepartment.Save_KpiLevelDepartment_nguoiguihoso", param);
                sqlMap.CommitTransaction();
            }
            catch (Exception ex)
            {
            ...
            logger.End("Save_KpiLevelDepartment_nguoiguihoso");
            return makpiphongban;
        }

        public bool Save_KpiLevelDepartment_Duyet_Khongduyet(string makpiphongban, string dongy, string landuyet)
        {
            logger.Start("Save_KpiLevelDepartment_Duyet_Khongduyet");
            bool strResult = true;
            try
            {
                sqlMap.BeginTransaction();
                ...
                if (landuyet.Trim() == "1")
                {
                    param["bankiemsoat_duyet"] = dongy;
                    param["photongxemxetkpi_duyet"] = "";
                    param["photongxemxetkpi_ngay"] = "";
                    param["tonggiamdocxemxetkpi_duyet"] = "";
                    param["tonggiamdocxemxetkpi_ngay"] = "";
                }
                else if (landuyet.Trim() == "2")
                {
                    param["bankiemsoat_duyet"] = "";
                    param["photongxemxetkpi_duyet"] = dongy;
                    param["photongxemxetkpi_ngay"] = DateTime.Now.ToString("dd/MM/yyyy");
                    param["tonggiamdocxemxetkpi_duyet"] = "";
                    param["tonggiamdocxemxetkpi_ngay"] = "";
                ...
                if (dongy == "2")
                {
                    param["nguoilapkpi_dagui"] = "2";
                    param["bankiemsoat_duyet1"] = "0";
                }
                else
                {
                    param["nguoilapkpi_dagui"] = "";
                    param["bankiemsoat_duyet1"] = "";
                }

                sqlMap.Update("KpiLevelDepartment.UpdateRow_KPIDepartment_Duyet_Khongduyet", param);
                sqlMap.CommitTransaction();
            }
            catch (Exception ex)
            {
            ...
            logger.End("Save_KpiLevelDepartment_Duyet_Khongduyet");
            return strResult;
        }
        ...
        #region KPI CẤP TRƯỞNG PHÒNG, GIÁM ĐỐC DỰ ÁN, PHÓ TỔNG GIÁM ĐỐC
        ...
        public int CountRows_KpiLevelDuDirectorTp(KpiLevelDuDirectorTpModels clparam, string grouptk, string Sessionid)
        {
            logger.Start("CountRows_KpiLevelDuDirectorTp");
            int iResult = 0;
            try
            {
                Hashtable param = new Hashtable();
                ...
                if (clparam.thongtintimkiem != "" && clparam.thongtintimkiem != "undefined" && clparam.thongtintimkiem != null)
                    param["thongtintimkiem"] = clparam.thongtintimkiem;
                else param["thongtintimkiem"] = "";

                iResult = (int)sqlMap.ExecuteQueryForObject("KpiLevelDuDirectorTp.CountRows_KpiLevelDuDirectorTp", param);
            }
            catch (Exception ex)
            {
                sqlMap.RollbackTransaction();
            ...
            logger.End("CountRows_KpiLevelDuDirectorTp");
            return iResult;
        }

        public List<KpiLevelDuDirectorTpModels> SelectRow_KpiLevelDuDirectorTp(KpiLevelDuDirectorTpModels clParam, int trangbd, int trangkt, string grouptk, string Sessionid)
        {
            logger.Start("SelectRow_KpiLevelDuDirectorTp");
            ...
            try
            {
                ...
                IList ilist = sqlMap.ExecuteQueryForList("KpiLevelDuDirectorTp.SelectRow_KpiLevelDuDirectorTp", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiLevelDuDirectorTpModels>(ilist);
            }
            catch (Exception ex)
            {
                logger.Error("Loi ---> " + ex.Message);
            }
            logger.End("SelectRow_KpiLevelDuDirectorTp");
            return lstResult;
        }


        public string Save_Du_Director_Tp(string DataJson, string nguoitao, string nguoilapgui, string photongduyet, string tonggiamdocduyet)
        {
            logger.Start("Save_Du_Director_Tp");
            string makpicanhancap = "";
            try
            {
                sqlMap.BeginTransaction();
                Hashtable param = new Hashtable();
                ...
                makpicanhancap = json["data1"]["makpicanhancap"].ToString();
                param["maphongban"] = json["data1"]["maphongban"].ToString();
                param["ngaybanhanh"] = json["data1"]["ngaybanhanh"].ToString();
                param["ngaycapnhat"] = json["data1"]["ngaycapnhat"].ToString();
                param["lancapnhat"] = "01";
                ...
                param["tonggiamdocxemxetkpi_duyet"] = tonggiamdocduyet;
                param["tonggiamdocxemxetkpi_email"] = json["data1"]["tonggiamdocxemxetkpi_email"].ToString();
                param["tonggiamdocxemxetkpi_ngay"] = json["data1"]["tonggiamdocxemxetkpi_ngay"].ToString();

                param["bankiemsoat_duyet"] = "0";
                param["nguoitao"] = nguoitao;
                if (makpicanhancap.Trim() == "" || makpicanhancap.Trim() == "0" || makpicanhancap.Trim() == null)
                {
                    param["makpicanhancap"] = GetSequence_All("dm_seq", "KPI_Level_Du_Director_Tp");
                    param["bankiemsoat_email"] = string.Format(Functiontring.ReturnStringFormatthongtincauhinhmail("smtp_user_bkskpi"));
                    sqlMap.Insert("KpiLevelDuDirectorTp.InsertRow_KpiLevelDuDirectorTp", param);
                }
                else
                {
                    param["makpicanhancap"] = makpicanhancap;
                    sqlMap.Update("KpiLevelDuDirectorTp.UpdateRow_KpiLevelDuDirectorTp", param);
                    //sqlMap.Update("KpiLevelDuDirectorTp.DeleteRow_KpiLevelDuDirectorTpDetail", param);
                }
                makpicanhancap = param["makpicanhancap"].ToString();
                Hashtable param1 = new Hashtable();
                JArray json_tiendo_giatri = (JArray)json["data2"];
                for (int i = 0; i < json_tiendo_giatri.Count(); i++)
                {
                    param1 = new Hashtable();
                    param1["makpicanhancap"] = param["makpicanhancap"].ToString().Trim();
                    param1["stt"] = json_tiendo_giatri[i]["stt"].ToString().Trim();

                    param1["makpicanhancap_chitiet"] = json_tiendo_giatri[i]["makpicanhancap_chitiet"].ToString().Trim();
                    ...
                    if (param1["makpicanhancap_chitiet"].ToString().Trim() == "" || param1["makpicanhancap_chitiet"].ToString().Trim() == "0" || param1["makpicanhancap_chitiet"].ToString().Trim() == null)
                    {
                        sqlMap.Insert("KpiLevelDuDirectorTp.InsertRow_KpiLevelDuDirectorTpDetail", param1);
                    }
                    else
                        sqlMap.Update("KpiLevelDuDirectorTp.UpdateRow_KpiLevelDuDirectorTpDetail", param1);
            ...
            logger.End("Save_Du_Director_Tp");
            return makpicanhancap;
        }


        public List<KpiLevelDuDirectorTpModels> SelectRows_KpiLevelDuDirectorTp_hieuchinh(string makpicanhancap)
        {
            logger.Start("SelectRows_KpiLevelDuDirectorTp_hieuchinh");
            List<KpiLevelDuDirectorTpModels> lstResult = new List<KpiLevelDuDirectorTpModels>();
            try
            {
                Hashtable param = new Hashtable();
                param["makpicanhancap"] = makpicanhancap;
                IList ilist = sqlMap.ExecuteQueryForList("KpiLevelDuDirectorTp.SelectRows_KpiLevelDuDirectorTp_hieuchinh", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiLevelDuDirectorTpModels>(ilist);
            }
            catch (Exception ex)
            ...
            logger.End("SelectRows_KpiLevelDuDirectorTp_hieuchinh");
            return lstResult;
        }

        public List<KpiLevelDuDirectorTpDetailModels> SelectRows_KpiLevelDuDirectorTpDetail_hieuchinh(string makpicanhancap)
        {
            logger.Start("SelectRows_KpiLevelDuDirectorTpDetail_hieuchinh");
            List<KpiLevelDuDirectorTpDetailModels> lstResult = new List<KpiLevelDuDirectorTpDetailModels>();
            try
            {
                Hashtable param = new Hashtable();
                param["makpicanhancap"] = makpicanhancap;
                IList ilist = sqlMap.ExecuteQueryForList("KpiLevelDuDirectorTp.SelectRows_KpiLevelDuDirectorTpDetail_hieuchinh", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiLevelDuDirectorTpDetailModels>(ilist);
            }
            catch (Exception ex)
            {
                logger.Error("Loi ---> " + ex.Message);
            }
            logger.End("SelectRows_KpiLevelDuDirectorTpDetail_hieuchinh");
            return lstResult;
        }


        public bool Save_KpiLevelDuDirectorTp_Duyet_Khongduyet(string makpicanhancap, string dongy, string landuyet,string chucdanh,string phongban)
        {
            logger.Start("Save_KpiLevelDepartment_Duyet_Khongduyet");
            bool strResult = true;
            try
            {
                ...
                {
                    if (chucdanh.Trim() != "6" && chucdanh.Trim() != "7" && chucdanh.Trim() != "8" && phongban.Trim() != "67")
                    {
                        param["bankiemsoat_duyet"] = "";
                        param["photongxemxetkpi_duyet"] = dongy;
                        param["photongxemxetkpi_ngay"] = DateTime.Now.ToString("dd/MM/yyyy");
                ...
                sqlMap.Update("KpiLevelDuDirectorTp.UpdateRow_KPIDuDirectorTp_Duyet_Khongduyet", param);
                sqlMap.CommitTransaction();
            }
            catch (Exception ex)
            {
        ...
        #region KPI CẤP CÔNG TRƯỜNG

        public int CountRows_KpiLevelConstruction(KpiLevelDepartmentModels clparam, string grouptk, string Sessionid)
        {
            logger.Start("CountRows_KpiLevelConstruction");
            int iResult = 0;
            try
            {
                Hashtable param = new Hashtable();
                ...
                iResult = (int)sqlMap.ExecuteQueryForObject("KpiLevelConstruction.CountRows_KpiLevelConstruction", param);
            }
            catch (Exception ex)
            {
                sqlMap.RollbackTransaction();
            ...
            logger.End("CountRows_KpiLevelConstruction");
            return iResult;
        }

        public List<KpiLevelDepartmentModels> SelectRow_KpiLevelConstruction(KpiLevelDepartmentModels clParam, int trangbd, int trangkt, string grouptk, string Sessionid)
        {
            logger.Start("SelectRow_KpiLevelConstruction");
            List<KpiLevelDepartmentModels> lstResult = new List<KpiLevelDepartmentModels>();
            try
            {
                Hashtable param = new Hashtable();
                ...
                param["trangbd"] = trangbd;
                param["trangkt"] = trangkt;
                IList ilist = sqlMap.ExecuteQueryForList("KpiLevelConstruction.SelectRow_KpiLevelConstruction", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiLevelDepartmentModels>(ilist);
            }
            catch (Exception ex)
            ...
            logger.End("SelectRow_KpiLevelConstruction");
            return lstResult;
        }


        public List<KpiLevelDepartmentDetailModels> SelectRows_KpiLevelConstruction_Item()
        {
            logger.Start("SelectRows_KpiLevelConstruction_Item");
            List<KpiLevelDepartmentDetailModels> lstResult = new List<KpiLevelDepartmentDetailModels>();
            try
            {
                Hashtable param = new Hashtable();
                IList ilist = sqlMap.ExecuteQueryForList("KpiLevelConstruction.SelectRows_KpiLevelConstruction_Item", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<KpiLevelDepartmentDetailModels>(ilist);
            }
            catch (Exception ex)
            ...
            logger.End("SelectRows_KpiLevelConstruction_Item");
            return lstResult;
        }

        public string Save_KpiLevelConstruction(string DataJson, string nguoitao, string nguoilapgui, string photongduyet, string tonggiamdocduyet)
        {
            logger.Start("Save_KpiLevelConstruction");
            string makpiphongban = "";
            try
            {
                sqlMap.BeginTransaction();
                ...
                param["bophansoanthao"] = json["data1"]["bophansoanthao"].ToString();
                param["thoigianthicongtu"] = json["data1"]["thoigianthicongtu"].ToString();
                param["thoigianthicongden"] = json["data1"]["thoigianthicongden"].ToString();
                param["hotengiamdocduan"] = json["data1"]["hotengiamdocduan"].ToString();
                ...
                if (makpiphongban.Trim() == "" || makpiphongban.Trim() == "0" || makpiphongban.Trim() == null)
                {
                    param["makpiphongban"] = GetSequence_All("dm_seq", "KPI_Level_Department");
                    param["bankiemsoat_email"] = string.Format(Functiontring.ReturnStringFormatthongtincauhinhmail("smtp_user_bkskpi"));
                    sqlMap.Insert("KpiLevelConstruction.InsertRow_KpiLevelConstruction", param);
                }
                else
                {
                    param["makpiphongban"] = makpiphongban;
                    sqlMap.Update("KpiLevelConstruction.UpdateRow_KpiLevelConstruction", param);
                    //sqlMap.Delete("KpiLevelConstruction.DeleteRow_KpiLevelConstructionDetail", param);
                }
                makpiphongban = param["makpiphongban"].ToString();
                Hashtable param1 = new Hashtable();
                JArray json_tiendo_giatri = (JArray)json["data2"];
                for (int i = 0; i < json_tiendo_giatri.Count(); i++)
                {
                    ...
                    if (param1["makpiphongban_chitiet"].ToString().Trim() == "" || param1["makpiphongban_chitiet"].ToString().Trim() == "0" || param1["makpiphongban_chitiet"].ToString().Trim() == null)
                    {
                        sqlMap.Insert("KpiLevelConstruction.InsertRow_KpiLevelConstructionDetail", param1);
                    }
                    else
                        sqlMap.Update("KpiLevelConstruction.UpdateRow_KpiLevelConstructionDetail", param1);
            ...
            logger.End("Save_KpiLevelConstruction");
            return makpiphongban;
        }
