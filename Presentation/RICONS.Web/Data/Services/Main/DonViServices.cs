...
{
    public class DonViServices : BaseData
    {
        public DonViServices()
        {
            logger = new Log4Net(typeof(DonViServices));
        }

        #region select
        public List<DonviModels> SelectRows(DonviModels clParam)
        {
            logger.Start("SelectRows");
            List<DonviModels> lstResult = new List<DonviModels>();
            try
            {
                Hashtable param = new Hashtable();
                param = base.SetDataToHashtable(false, clParam);
                IList ilist = sqlMap.ExecuteQueryForList("m_donvi.SelectRows", param);
                CastDataType cast = new CastDataType();
                lstResult = cast.AdvanceCastDataToList<DonviModels>(ilist);
            }
            catch (Exception ex)
            {
        ...
        public int CountRows(DonviModels clparam)
        {
            ...
            try
            {
                Hashtable param = new Hashtable();
                param = base.SetDataToHashtable(false, clparam);
                iResult = (int)sqlMap.ExecuteQueryForObject("m_donvi.CountRows", param);
            }
            catch (Exception ex)
            {
        ...
        public DonviModels RowDetail(DonviModels clparam)
        {
            logger.Start("RowDetail");
            DonviModels vbResult = new DonviModels();
            try
            {
                Hashtable param = new Hashtable();
                param = base.SetDataToHashtable(false, clparam);
                IList ilist = sqlMap.ExecuteQueryForList("m_donvi.RowDetail", param);
                CastDataType cast = new CastDataType();
                vbResult = cast.AdvanceCastDataToList<DonviModels>(ilist)[0];
            }
            catch (Exception ex)
            {
                logger.Error(ex.Message);
                vbResult = new DonviModels();
            }
        ...
        public string InsertRow(DonviModels clParam)
        {
            ...
            try
            {
                ...
                sqlMap.Insert("m_donvi.InsertRow", param);
        ...
        #region update
        public bool UpdateRow(DonviModels clParam)
        {
            ...
            try
            {
                ...
                sqlMap.Update("m_donvi.UpdateRow", param);
                sqlMap.CommitTransaction();
                bResult = true;
            }
            catch (Exception ex)
        ...
        public bool UpdateRow(string idRow, string strColumn, string strValue, string strNguoiHieuChinh)
        {
            ...
            try
            {
                ...
                sqlMap.Update("m_donvi.UpdateRow_OnCell", param);
                sqlMap.CommitTransaction();
                bResult = true;
            }
            catch (Exception ex)
        ...
        #region Delete
        public bool DeleteRows(List<DonviModels> clParam)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < clParam.Count; i++)
                {
                    ...
                    sqlMap.Update("m_donvi.DeleteRow", param);
                }
                sqlMap.CommitTransaction();
                lstResult = true;
            }
