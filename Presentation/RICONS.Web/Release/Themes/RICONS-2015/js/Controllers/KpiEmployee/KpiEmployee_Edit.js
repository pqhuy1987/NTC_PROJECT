...
var configChosenDanhmucvanphongpham = {
    ...
    '.chosen-select-loaikehoach2': { width: "100%", disable_search_threshold: 10 },
    '.chosen-select-loaikehoach3': { width: "100%", disable_search_threshold: 10 },
    '.chosen-select-loaikehoach4': { width: "100%", disable_search_threshold: 10 }
}
...
$(document).ready(function (e) {
    ...
    $('#btn-inbieumau').click(function (e) {
        debugger;
        var DataJson = "{'makpinhanvien':'" + $('#txtmakpinhanvien').val() + "'}";
        fncPostData(linkContent + 'KpiEmployee/XuatExcel', DataJson);
    });
