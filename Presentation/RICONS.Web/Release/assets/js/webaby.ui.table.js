        ...
        self.initTable = function () {
            ...
            if (settings.paging != false) {
                var tfoot = '<div class="display-block" style="overflow: hidden; padding: 15px">' +
                    '<ul class="pagination bootpag pagination-flat pagination-sm pull-right"></ul>';
                if (settings.paging.options != null) {
                    var opts = settings.paging.options;
                    tfoot += '<div class="pull-right mr-10" style="width:175px"><span style="display: inline-block">Hiển thị</span>' +
                        '<div class="form-group form-group-xs ml-10 mr-10"  style="display: inline-block; margin-bottom: 0">' +
                        '<select class="form-control limitation" style="width: 60px;display: inline; padding: 0">';
