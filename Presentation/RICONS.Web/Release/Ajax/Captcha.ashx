...
public class Captcha : IHttpHandler, IReadOnlySessionState, IRequiresSessionState
{
    private string strSessionCaptcha = "Captcha";
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        SetCaptchaText(context);
        string sCaptchaText = context.Session[strSessionCaptcha].ToString();
    ...
    private void SetCaptchaText(HttpContext context)
    {        
        Random oRandom = new Random();
        int iNumber = oRandom.Next(100000, 999999);
        context.Session[strSessionCaptcha] = iNumber.ToString();
    }
}