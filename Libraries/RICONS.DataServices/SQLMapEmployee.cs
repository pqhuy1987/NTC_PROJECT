...
{
    public class SQLMapEmployee
    {
        #region properties
        protected SqlMapper sqlMapEmployee;
        /// <summary>
        /// SQLConfig file
        /// </summary>
        ...
        /// logger
        /// </summary>
        public Log4Net logger = new Log4Net(typeof(SQLMapEmployee));
        ...
        public bool BeginTransaction()
        {
            ...
            try
            {
                sqlMapEmployee.BeginTransaction();
        ...
        public bool CommitTransaction()
        {
            ...
            try
            {
                sqlMapEmployee.CommitTransaction();
        ...
        public bool RollbackTransaction()
        {
            ...
            try
            {
                sqlMapEmployee.RollBackTransaction();
        ...
        public object ExecuteQueryForObject(string str_sqlID, object parameter)
        {
            ...
            try
            {
                obj = sqlMapEmployee.QueryForObject(str_sqlID, parameter);
                if (obj != null)
        ...
        public string ExcuteQueryForString(string str_sqlID, object parameter)
        {
            ...
            try
            {
                Object obj = sqlMapEmployee.QueryForObject(str_sqlID, parameter);
                if (obj != null)
                {
        ...
        public IList ExecuteQueryForListNotLog(string str_sqlID, object parameter)
        {
            ...
            try
            {
                list = sqlMapEmployee.QueryForList(str_sqlID, parameter);
        ...
        public object Insert(string str_SqlID, object parameter)
        {
            ...
            try
            {
                result = sqlMapEmployee.Insert(str_SqlID, parameter);
        ...
        public object Delete(string str_SqlID, object parameter)
        {
            ...
            try
            {
                result = sqlMapEmployee.Delete(str_SqlID, parameter);
                //CommitTransaction();
                logger.Debug("Success!");
            }
            catch (Exception ex)
        ...
        public object Update(string str_SqlID, object parameter)
        {
            ...
            try
            {
                result = sqlMapEmployee.Update(str_SqlID, parameter);
                //CommitTransaction();
                logger.Debug("Success!");
            }
            catch (Exception ex)
